...
namespace systems
{
  ...
  {
    /// \brief Constructor
    public: SuctionPlugin();

    /// \brief Destructor
    public: ~SuctionPlugin() override = default;
    ...
    private: std::unique_ptr<SuctionPluginPrivate> dataPtr;

    private: bool isAttached{false};
    private: void OnDetachRequest(const msgs::Empty &_msg);
    private: bool detachRequested{false};
    private: bool attachRequested{true}; // TODO set to false
  };
  }
}
}
